...
#ifndef _toThreshold_CvtColor_HH_
#define _toThreshold_CvtColor_HH_
...
struct toThreshold_CvtColor : public sc_module {
    ...
    // Module declarations
    toThreshold_CvtColor(sc_module_name name);
    SC_HAS_PROCESS(toThreshold_CvtColor);

    ~toThreshold_CvtColor();
    ...
    sc_signal< sc_lv<8> > tmp_118_reg_322;
    sc_signal< sc_lv<8> > tmp_119_reg_327;
    sc_signal< sc_lv<8> > ap_reg_ppstg_tmp_119_reg_327_pp0_it2;
    ...
    sc_signal< sc_lv<8> > p_Val2_13_reg_342;
    sc_signal< sc_lv<1> > tmp_reg_347;
    sc_signal< sc_lv<1> > tmp_115_reg_352;
    ...
    sc_signal< sc_lv<31> > p_Val2_11_fu_209_p2;
    sc_signal< sc_lv<8> > r_V_3_i_fu_221_p0;
    sc_signal< sc_lv<32> > r_V_3_i_fu_221_p2;
    sc_signal< sc_lv<32> > r_V_1_fu_227_p2;
    sc_signal< sc_lv<8> > tmp_82_i_i_i_fu_258_p1;
    sc_signal< sc_lv<8> > p_Val2_14_fu_261_p2;
    sc_signal< sc_lv<1> > tmp_116_fu_266_p3;
    sc_signal< sc_lv<1> > p_Result_4_i_i_i_not_fu_274_p2;
    ...
    void thread_p_Result_4_i_i_i_not_fu_274_p2();
    void thread_p_Val2_11_fu_209_p2();
    void thread_p_Val2_14_fu_261_p2();
    ...
    void thread_tmp_116_fu_266_p3();
    void thread_tmp_82_i_i_i_fu_258_p1();
