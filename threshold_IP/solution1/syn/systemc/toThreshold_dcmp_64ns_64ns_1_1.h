...
#ifndef __toThreshold_dcmp_64ns_64ns_1_1__HH__
#define __toThreshold_dcmp_64ns_64ns_1_1__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(toThreshold_dcmp_64ns_64ns_1_1) {
    ...
    SC_CTOR(toThreshold_dcmp_64ns_64ns_1_1):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
