...
#ifndef _toThreshold_AXIvideo2Mat_HH_
#define _toThreshold_AXIvideo2Mat_HH_
...
struct toThreshold_AXIvideo2Mat : public sc_module {
    ...
    // Module declarations
    toThreshold_AXIvideo2Mat(sc_module_name name);
    SC_HAS_PROCESS(toThreshold_AXIvideo2Mat);

    ~toThreshold_AXIvideo2Mat();
    ...
    sc_signal< sc_lv<8> > tmp_114_fu_363_p1;
    sc_signal< sc_lv<8> > tmp_114_reg_444;
    sc_signal< sc_lv<8> > tmp_30_reg_449;
    sc_signal< sc_lv<8> > tmp_31_reg_454;
