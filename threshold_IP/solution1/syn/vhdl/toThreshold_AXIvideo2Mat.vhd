...
entity toThreshold_AXIvideo2Mat is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of toThreshold_AXIvideo2Mat is 
    ...
    signal tmp_114_fu_363_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_114_reg_444 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_30_reg_449 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_31_reg_454 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_4) and (exitcond2_fu_330_p2 = ap_const_lv1_0) and not(((ap_sig_bdd_120 and (ap_const_logic_1 = ap_reg_ppiten_pp1_it0)) or (ap_sig_bdd_133 and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1)))))) then
                ...
                tmp_30_reg_449 <= p_Val2_s_phi_fu_245_p4(15 downto 8);
                tmp_31_reg_454 <= p_Val2_s_phi_fu_245_p4(23 downto 16);
            end if;
        end if;
    end process;
    ...
    img_data_stream_0_V_din <= tmp_114_reg_444;
    ...
    img_data_stream_1_V_din <= tmp_30_reg_449;
    ...
    img_data_stream_2_V_din <= tmp_31_reg_454;
    ...
    tmp_114_fu_363_p1 <= p_Val2_s_phi_fu_245_p4(8 - 1 downto 0);
